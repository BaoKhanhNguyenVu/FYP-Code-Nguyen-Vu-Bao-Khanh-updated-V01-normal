...
CREATE TABLE `Follow` (
    ...
    `followimgId` VARCHAR(191) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Follow` ADD CONSTRAINT `Follow_followimgId_fkey` FOREIGN KEY (`followimgId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
